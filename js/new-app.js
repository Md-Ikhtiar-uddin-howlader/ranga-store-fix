      ...
      div.innerHTML = `
        <div class="card h-100 shadow-lg">
            ...
            <span class="p-3 bg-card">
              ...
              <p>
              <span class="icon fw-bold">Rating: <i class="fas fa-star text-warning"></i> ${product.rating.rate}</span>
              </p>
              <p>
              <span class="icon fw-bold">Rating Count: <i class="fas fa-user-check text-warning"></i> ${product.rating.count}</span>
              </p>
              <div class="d-flex justify-content-around">
                <button onclick="addToCart(${product.price})" id="addToCart-btn" class="buy-now btn btn-dark fw-bold">Add To Cart</button>
                <button id="addToCart-btn" class="buy-now btn btn-dark fw-bold">Details</button>
